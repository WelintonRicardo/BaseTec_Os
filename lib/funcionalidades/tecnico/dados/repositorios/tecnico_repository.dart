...
class TecnicoRepository {
  ...
  Future<Map<String, dynamic>>
      carregarDashboardTecnico() async {
...
Future<List<Map<String, dynamic>>>
  ...
  try {
    ...
    final listaFiltrada =
      ...
      final dataOs =
          DateTime.parse(dataOsString);

      return
          dataOs.year == data.year &&
